...
/*
 * if (WebDriverExpectedCondition::elementTextContains($saveButton, "opBarBtnLabel saved opBarBtnLabelDisabled")) {
 * echo "saved2\n";
 * }
 *
 * if(WebDriverExpectedCondition::visibilityOfElementLocated(WebDriverBy::classname('opBarBtnLabel saved opBarBtnLabelDisabled')) ){
 * echo "saved4\n";
 * };
 */
// }
...
/*
 * gets the class of iframe
 * $my_frame = $this->driver->findElement(WebDriverBy::cssSelector("x-component main-content-iframe x-box-item x-component-default"))
 */

/*
 * $this->driver->wait(20, 1000)->until(
 * WebDriverExpectedCondition::visibilityOfElementLocated(WebDriverBy::cssSelector('x-component main-content-iframe x-box-item x-component-default'))
 * );
 */

/*
 * waits until iframe is changed
 * $this->driver->wait()->until(
 * WebDriverExpectedCondition::frameToBeAvailableAndSwitchToIt(
 * $this->driver->switchTo()->frame(0)));
 */

// if ($isOneiframePresent == "True") {

/*
 * if (WebDriverExpectedCondition::elementTextContains(WebDriverBy::id('OperationDivSave'), "cccccccccccc")) {
 * echo "saved1\n";
 * } else {
 * echo "save2\n";
 * }
...
// // counts the iframe size
// echo "iframe size is: " . $iframeSize . "\n";

/*
 * if(WebDriverExpectedCondition::invisibilityOfElementLocated(WebDriverBy::classname('opBarBtnLabel saved opBarBtnLabelDisabled'))){
 * echo "not saved3\n";
 * };
 */
 ...
 * }
 */
// $isOneiframePresent = "True"; // to execute rest of the code
// echo "iframe found \n";
?>